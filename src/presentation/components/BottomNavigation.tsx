...
export function BottomNavigation() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg" style={{ borderColor: 'rgba(0, 128, 0, 0.1)', paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
