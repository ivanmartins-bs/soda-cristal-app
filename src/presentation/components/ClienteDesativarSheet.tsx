...
export function ClienteDesativarSheet({ open, onOpenChange, cliente, onSaved }: ClienteDesativarSheetProps) {
  ...
  const handleSave = async () => {
    ...
    const confirmacao = window.confirm(`Tem certeza que deseja inativar o cliente ${cliente.cliente.nome}? Essa ação encerrará o atendimento.`);
